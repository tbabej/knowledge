...
def convert_to_pdf():
    ...
    preamble = '\n'.join([
       ...
       'classoption: [oneside]',
       r'footer-center: \knowledgeCornerControls',
       'header-includes:',
       '- |',
       '  ```{=latex}',
       ...
       r'  \newcommand{\knowledgeCornerControls}[0]{',
       r'      \begin{tikzpicture}[overlay, remember picture]',
       r'          \node[anchor=north east, xshift=-0.4cm, yshift=-0.6cm] at (current page.north east){',
       r'              \showocg{\forlistloop{\printocg}{\allocgs}}{\fontsize{8}{2}\selectfont \faClipboardCheck \kern2pt show}};',
